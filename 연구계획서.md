...
3) Intangible Assets: Human, Knowledge, Technology, Brand

> Intelligent Analytics
1) Descriptive Analytics(What's happening and why?): Data Aggregation, DataOps, Preprocessing, Exploratory Data Analysis(EDA)
2) Predictive Analytics(What's likely to happen?): Statistical Models, Optimization, Prediction, Automatic Analysis
3) Prescriptive Analytics(What should we need to do?): Expert System, Simulation, Explainable AI, Actionable Intelligence
